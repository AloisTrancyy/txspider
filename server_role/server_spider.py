...
if __name__ == "__main__":
    ...
    url = 'http://tx3.cbg.163.com/cgi-bin/overall_search.py?act=overall_search_role&level_min=69&level_max=80&price_min=100000&price_max=30000000&school=1&page=1'
